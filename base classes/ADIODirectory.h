...
#ifndef ADDIRECTORY_H
#define ADDIRECTORY_H

#include "ADIOBase.h"
#include "ADIOFileRef.h"
#include "ADIOFile.h"

namespace AccessData
{

enum EDirectorySearchAttributes
{
	dsaANY			= 0,
	dsaFILE			= 1,
	dsaDIRECTORY	= 2,
...
{
public:
	virtual CFile*		FindFirst(const wstring &name, int attribs) = 0;
	virtual CFile*		FindNext(const wstring &name, int attribs) = 0;
	virtual void		FindReset() = 0;
};
